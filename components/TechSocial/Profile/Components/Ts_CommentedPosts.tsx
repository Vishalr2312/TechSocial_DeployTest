...
import Ts_CommentedPostFeeds from "./Commented-Posts/Ts_CommentedPostFeeds";
  ...
  return (
    <>
      ...
      <div className="col-xxl-6 col-xl-5 col-lg-8 mt-0 mt-lg-10 mt-xl-0 d-flex flex-column gap-7 cus-z">
        ...
        {/* Feeds */}
        <Ts_CommentedPostFeeds clss="p-3 p-sm-5" />
      </div>
...
export default Ts_CommentedPosts;
