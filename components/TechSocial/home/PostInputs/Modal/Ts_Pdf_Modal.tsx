...
function Ts_Pdf_Modal() {
  return (
    <div className="go-live-popup video-popup">
      <div className="container">
        <div className="row">
          <div className="col-lg-8">
            <div className="modal cmn-modal fade" id="goTsPdfMod">
                    ...
                    <div className="file-upload">
                      ...
                      <label className="file mt-1">
                        ...
                        <span className="file-custom pt-8 pb-8 d-grid text-center">
                          ...
                          <span>Drag here or click to upload pdf/document.</span>
                        </span>
                      </label>
                    </div>
                  </div>
